...
public:
	...
	{
		auto table = to_state.get_table(this->table_name_lower());
		auto col = table.get_column(this->name_lower());
		xw::util::require_non_null(
			editor, ce<AddColumn>("forward", "schema editor is nullptr")
	...
	{
		auto table = from_state.get_table(this->table_name_lower());
		auto col = table.get_column(this->name_lower());
		xw::util::require_non_null(
			editor, ce<AddColumn>("backward", "schema editor is nullptr")
