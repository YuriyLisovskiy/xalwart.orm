...
struct TestBuilder_TestModel : public orm::db::Model
{
	...
	{
		this->__orm_set_column_data__(TestBuilder_TestModel::meta_columns, column_name, data);
	}
};
...
public:
	...
	inline void __orm_set_column__(const std::string& column_name, const char* data) override
	{
		this->__orm_set_column_data__(LeftTestModel::meta_columns, column_name, data);
	}
};
...
public:
	...
	inline void __orm_set_column__(const std::string& column_name, const char* data) override
	{
		this->__orm_set_column_data__(RightTestModel::meta_columns, column_name, data);
	}
};
